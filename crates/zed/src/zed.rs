...
fn initialize_panels(window: &mut Window, cx: &mut Context<Workspace>) -> Task<anyhow::Result<()>> {
    cx.spawn_in(window, async move |workspace_handle, cx| {
        ...
        let reader_panel = reader::ReaderPanel::load(workspace_handle.clone(), cx.clone());
        let contents_panel = reader::ContentsPanel::load(workspace_handle.clone(), cx.clone());
        let channels_panel =
        ...
        futures::join!(
            ...
            add_panel_when_ready(reader_panel, workspace_handle.clone(), cx.clone()),
            add_panel_when_ready(contents_panel, workspace_handle.clone(), cx.clone()),
